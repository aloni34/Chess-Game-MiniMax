...
class ImageCollection(object):
    ...
    def decompress_images(self):
        ...
        image_names = ["pawn_black.png", "pawn_white.png", "rook_black.png", "rook_white.png", "knight_black.png", "knight_white.png", "bishop_black.png", "bishop_white.png", "queen_black.png", "queen_white.png", "king_black.png", "king_white.png"]
        image_list = []

        for i in range(len(image_names)):

            image = Image.open("Images" + '\\' + image_names[i])
            image = image.resize((S_T.HEIGHT // 11, S_T.HEIGHT // 11), Image.ANTIALIAS)
        ...
        for i in range(len(image_names)):
            ...
            image = Image.open("Images" + '\\' + image_names[i])
            image = image.resize((S_T.HEIGHT // 5, S_T.HEIGHT // 11), Image.ANTIALIAS)
            logo1 = ImageTk.PhotoImage(image)
            image_list.append((logo1))
